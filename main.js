...
var author$project$Util$Connect = function (a) {
	return {$: 'Connect', a: a};
};
var author$project$Util$Error = function (a) {
	return {$: 'Error', a: a};
};
var author$project$Util$Recieve = function (a) {
	return {$: 'Recieve', a: a};
};
	...
	return author$project$Websocket$events(
		function (event) {
			switch (event.$) {
				case 'Connected':
					var info = event.a;
					return author$project$Util$Connect(info);
				case 'StringMessage':
					var message = event.b;
					return author$project$Util$Recieve(message);
				case 'Closed':
					var unsent = event.b;
					return author$project$Util$Closed(unsent);
				case 'Error':
					var code = event.b;
					return author$project$Util$Error(
						'Websocket Error: ' + elm$core$String$fromInt(code));
				default:
					var error = event.a;
					return author$project$Util$Error(error);
			}
		});
};
...
var author$project$Util$parseUrl = function (url) {
	return A2(
...
var author$project$Question$option = F2(
	function (txt, msg) {
		return A2(
...
var author$project$Util$Answer = function (a) {
	return {$: 'Answer', a: a};
};
			...
			[
				...
				A2(
					...
					_List_fromArray(
						[
							A2(
							author$project$Question$option,
							'A',
							author$project$Util$Answer(0)),
							A2(
							author$project$Question$option,
							'B',
							author$project$Util$Answer(1)),
							A2(
							author$project$Question$option,
							'C',
							author$project$Util$Answer(2)),
							A2(
							author$project$Question$option,
							'D',
							author$project$Util$Answer(3))
						])))
			]),
		title: 'Quiz game'
	};
};
var author$project$Review$view = function (model) {
	var content = function () {
		var _n0 = model.correct;
		if (_n0) {
			return mdgriffith$elm_ui$Element$text('Correct!');
		} else {
			return mdgriffith$elm_ui$Element$text('Better luck next time!');
		}
	}();
	return {
		body: _List_fromArray(
...
var author$project$Util$Change = function (a) {
	return {$: 'Change', a: a};
};
var author$project$Util$Req = function (a) {
	return {$: 'Req', a: a};
};
var elm$browser$Browser$application = _Browser_application;
var author$project$Main$main = elm$browser$Browser$application(
	{init: author$project$Main$init, onUrlChange: author$project$Util$Change, onUrlRequest: author$project$Util$Req, subscriptions: author$project$Main$subscriptions, update: author$project$Main$update, view: author$project$Main$view});
